...
import { 
  ...
  MessageSquare, ThumbsUp, Edit3, Loader2, Bell, BellRing
} from 'lucide-react';
...
export default function FinanceApp() {
  ...
  const saveDataToFirebase = useCallback(async () => {
    ...
    setIsSaving(false);
  }, [masterData, ledgerEntries, receipts, creditNotes, openingBalances, mailerImages, mailerLogo, companyConfig, nextInvoiceNo, nextCombineNo, nextReceiptNo, nextCreditNoteNo, invoiceValues, notifications]);
  ...
  }, [masterData, ledgerEntries, receipts, creditNotes, openingBalances, mailerImages, mailerLogo, companyConfig, nextInvoiceNo, nextCombineNo, nextReceiptNo, nextCreditNoteNo, invoiceValues, notifications, isLoggedIn]);
      ...
      <div>
        ...
        <Card noPadding>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
            ...
            <tbody>
              {invoices.length === 0 ? (
                <tr><td colSpan="9" style={{ padding: '50px', textAlign: 'center', color: '#94A3B8' }}>{hasInvoiceFilters ? 'No matching invoices' : 'No invoices generated yet'}</td></tr>
              ) : (
                invoices.map(inv => (
